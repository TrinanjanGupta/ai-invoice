    ...
    def evaluate(self, invoice_dict: dict, ocr_avg_conf: float = 0.90) -> dict[str, Any]:
        ...
        if v_gstin:
            if validate_gstin_checksum(str(v_gstin)):
                ...
                field_confidences["vendor_gstin"] = 0.88
            else:
                field_confidences["vendor_gstin"] = 0.50
                fields_needing_review.append("vendor_gstin")
                review_reasons.append("Vendor GSTIN checksum/format invalid")
        ...
        if b_gstin:
            if validate_gstin_checksum(str(b_gstin)):
                ...
                field_confidences["buyer_gstin"] = 0.55
        ...
        # 6. Financial Arithmetic Cross-Validation
        ...
        if grand_total is not None and grand_total > 0:
            ...
            if subtotal is not None and subtotal > 0:
                ...
                if diff <= max(1.0, grand_total * 0.01):
        ...
        # Segregate auto-accepted vs review fields
        ...
        if field_confidences:
            weights = {"grand_total": 2.0, "invoice_number": 2.0, "invoice_date": 1.5, "vendor_name": 1.5, "vendor_gstin": 1.5}
        ...
        return {
            ...
            "needs_review": len(fields_needing_review) > 0 or not arithmetic_valid,
